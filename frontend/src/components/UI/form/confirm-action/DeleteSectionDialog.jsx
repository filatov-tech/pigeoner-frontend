...
const DeleteSectionDialog = (props) => {
    ...
    const text = {
        ...
        ROOM: "Вы пытаетесь удалить секцию. Это приведет к удалению всех вложенных секций и гнезд. Все голуби переместяться в раздел \"Нераспределенные\"",
        DOVECOTE: "Внимание! Удаление голубятни приведет к удалению всех вложенных секций и гнезд. Все голуби переместяться в раздел \"Нераспределенные\""
    };
    const title = {
        NEST: "гнезда",
        ROOM: "секции",
